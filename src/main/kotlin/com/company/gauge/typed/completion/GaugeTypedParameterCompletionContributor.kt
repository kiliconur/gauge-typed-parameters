    ...
    private class TypedParameterCompletionProvider : CompletionProvider<CompletionParameters>() {
        ...
        override fun addCompletions(
            ...
            try {
                ...
                LOG.warn("Gauge typed parameter completion failed", e)
            }
        }
        ...
        private fun doAddCompletions(parameters: CompletionParameters, result: CompletionResultSet) {
            ...
            val resolved = TypedParameterResolver.resolve(project, parameterContext) ?: return

            val provider = PROVIDERS.firstOrNull { it.supports(resolved.kind) } ?: return
        ...
        private companion object {
            val LOG: Logger = Logger.getInstance(GaugeTypedParameterCompletionContributor::class.java)
