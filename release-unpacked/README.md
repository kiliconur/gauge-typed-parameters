...
[`../release/gauge-typed-parameters-1.2.0.zip`](../release/gauge-typed-parameters-1.2.0.zip),
...
└── gauge-typed-parameters/
    └── lib/
        └── gauge-typed-parameters-1.2.0.jar
```
...
4. Rename the result to:
   ...
   ```
   gauge-typed-parameters-1.2.0.zip
   ```
...
[IO.Compression.ZipFile]::OpenRead("gauge-typed-parameters-1.2.0.zip").Entries |
...
```
%APPDATA%\JetBrains\IntelliJIdea2026.2\plugins\gauge-typed-parameters\lib\gauge-typed-parameters-1.2.0.jar
```
